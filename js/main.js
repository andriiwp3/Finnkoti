...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if ($('.hero__slider').length > 0) {
    ...
    if ($('.hero__slider .slick-list')) {
      $('.hero__slider .slick-list').addClass('hero__slick-list');
    }
  ...
  if ($('.steps__slider').length > 0) {
    ...
    if ($('.steps__slider .slick-list')) {
      $('.steps__slider .slick-list').addClass('steps__slick-list');
    }
  }
  ...
  setTimeout(function () {
    ...
    !function (e) {
      ...
      var m = a.MutationObserver || a.WebKitMutationObserver || !1,
        ...
        this.delegate = function (e, o, t, r, i) {
          ...
          return 0 === T.page.maxh || !T.ispage && "none" == T.win.css("display") || (T.rail.visibility = !0, T.rail.css("display", "block"), T.rail.parent().removeClass("noscroll")), T;
        }, this.showRailHr = function () {
          return T.railh && (0 === T.page.maxw || !T.ispage && "none" == T.win.css("display") || (T.railh.visibility = !0, T.railh.css("display", "block"))), T;
        }, this.hideRails = function () {
          return T.hideRail().hideRailHr();
        }, this.hideRail = function () {
          return T.rail.visibility = !1, T.rail.css("display", "none"), T.rail.parent().addClass("noscroll"), T;
        ...
        var select = function select() {
          $.each($('select'), function (index, val) {
            ...
            if ($(this).attr('data-type') == 'search') {
              ...
              sblock.append("<div class='select_" + ind + " select" + " " + $(this).attr('class') + "__select icon " + milti + "'>" + "<div class='select-title'>" + "<div class='select-title__arrow ion-ios-arrow-down'></div>" + "<div class='select-title__value value_" + $(this).find('option[selected="selected"]').val() + "'><div><img src=" + $(this).find('option[selected="selected"]').attr('data-icon') + " alt=\"\"></div><div>" + $(this).find('option[selected="selected"]').html() + "</div></div>" + "</div>" + soptions + "</div>");
            } else {
    ...
    var officeHoursBlocks = document.querySelectorAll(".office-hours");

    if (officeHoursBlocks.length > 0) {
      var changeWorkStatus = function changeWorkStatus(isOpen) {
        var block = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.querySelector(".office-hours");

        if (isOpen) {
          block.classList.remove("office-hours_close");
          block.textContent = "".concat(officeHoursObj.officeHoursInKievTimeZone.officeHoursStart, ":00 - ").concat(officeHoursObj.officeHoursInKievTimeZone.officeHoursEnd, ":00 \u043F\u043E \u041A\u0438\u0435\u0432\u0443");
        } else {
          block.classList.add("office-hours_close");
          block.innerHTML = "\u041E\u0442\u043A\u0440\u044B\u0432\u0430\u0435\u0442\u0441\u044F \u0432 ".concat(officeHoursObj.officeHoursInKievTimeZone.officeHoursStart, ":00 \u043F\u043E \u041A\u0438\u0435\u0432\u0443");
        }
      };

      var officeHoursObj = {
        officeHoursInKievTimeZone: {
          officeHoursStart: "09",
          officeHoursEnd: "21"
        },
        officeHoursUTC: {
      ...
      officeHoursBlocks.forEach(function (item) {
        var officeHoursBlock = item;
    ...
    var showTooltip = function showTooltip(blocksClass) {
      var triggers = document.querySelectorAll(".".concat(blocksClass, "__trigger"));

      if (triggers.length > 0) {
        triggers.forEach(function (trigger, index) {
          var wrapper = trigger.closest(".".concat(blocksClass, "__img"));
          var tooltip = wrapper.querySelectorAll(".".concat(blocksClass, "__tooltip"))[index];
